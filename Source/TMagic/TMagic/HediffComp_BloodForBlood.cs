                        ...
                        foreach (Hediff_Injury current in arg_BB_0.Where(arg_BB_1))
                        {
                            ...
                            {                                
                                ...
                                if (flag5)
                                {
                                    ...
                                    TM_MoteMaker.ThrowGenericMote(ThingDef.Named("Mote_BloodMist"), this.Pawn.DrawPos, this.Pawn.Map, Rand.Range(.5f, .85f), .2f, 0.05f, 1f, Rand.Range(-50, 50), Rand.Range(1f, 1.7f), (Quaternion.AngleAxis(Rand.Range(70f, 110f), Vector3.up) * this.directionToLinkedPawn).ToAngleFlat(), Rand.Range(0, 360));
                                    num--;
                                    num2--;
                                }
                            }
