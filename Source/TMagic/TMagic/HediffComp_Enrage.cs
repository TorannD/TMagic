...
namespace TorannMagic
{
    ...
    class HediffComp_Enrage : HediffComp
    {
        ...
        public void DrawEffects()
        {
            ...
            //    TM_MoteMaker.ThrowGenericMote(ThingDef.Named("Mote_Demon_Flame"), headOffset, this.Pawn.Map, Rand.Range(.5f, .8f) * sizeOffset, Rand.Range(.12f, .18f), .01f, Rand.Range(.1f, .15f), 0, Rand.Range(2.4f, 2.8f) * sizeOffset, throwAngle, Rand.Range(0, 360));
            //}
            //else if (this.Pawn.Rotation == Rot4.South)
            //{
            //    headOffset.z += .75f * sizeOffset;
            //    TM_MoteMaker.ThrowGenericMote(ThingDef.Named("Mote_Demon_Flame"), headOffset, this.Pawn.Map, Rand.Range(.5f, .8f) * sizeOffset, Rand.Range(.12f, .18f), .01f, Rand.Range(.1f, .15f), 0, Rand.Range(2.4f, 2.8f) * sizeOffset, Rand.Range(-30, 30), Rand.Range(0, 360));
            //}
            //else
            //{
            //    headOffset.z += .75f * sizeOffset;
