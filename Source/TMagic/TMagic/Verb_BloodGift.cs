            ...
            if (pawn != null && !pawn.Downed && bodyparts != null && bloodDefs != null)
            {
                ...
                if(validParts.Count > 0)
                {
                    if (this.CasterPawn.RaceProps.BloodDef != null && (this.CasterPawn.RaceProps.BloodDef == ThingDefOf.Filth_Blood || settingsRef.unrestrictedBloodTypes))
                    {
                        ...
                        TM_Action.DamageEntities(this.CasterPawn, damagePart, 4f, TMDamageDefOf.DamageDefOf.TM_BloodyCut, this.CasterPawn);
                        damagePart = validParts.RandomElement();
                        TM_Action.DamageEntities(this.CasterPawn, damagePart, 2f, TMDamageDefOf.DamageDefOf.TM_BloodyCut, this.CasterPawn);
                        bloodGain += 10;
