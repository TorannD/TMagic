...
namespace TorannMagic
{
    public class Verb_RegrowLimb : Verb_UseAbility
    {
        ...
        public override bool CanHitTargetFrom(IntVec3 root, LocalTargetInfo targ)
        {
            ...
            if (targ.IsValid && targ.CenterVector3.InBounds(base.CasterPawn.Map) && !targ.Cell.Fogged(base.CasterPawn.Map) && targ.Cell.Walkable(base.CasterPawn.Map) && targ.Cell.Standable(base.CasterPawn.Map))
            {
