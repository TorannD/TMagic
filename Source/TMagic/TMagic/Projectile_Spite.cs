...
namespace TorannMagic
{
    public class Projectile_Spite : Projectile_AbilityBase
    {
        ...
        public override void Tick()
        {
            ...
            TM_MoteMaker.ThrowGenericMote(ThingDef.Named("Mote_SpiritFlame"), this.DrawPos, this.Map, Rand.Range(.3f, .4f), .05f, 0.05f, .1f, Rand.Range(-300, 300), Rand.Range(.2f, .6f), Rand.Range(0, 360), Rand.Range(0, 360));
            base.Tick();
        }
