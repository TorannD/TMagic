...
namespace TorannMagic
{
    ...
    public class Verb_ApplyRandomHediffFromList : Verb_SB
    {
        ...
        int CountUpgrade => Properties.countUpgrade == null ? 0
            : CasterPawn?.TryGetComp<CompAbilityUserCustom>().Data.GetUpgradeLevel(Properties.countUpgrade.UpgradeId) ?? 0;
        int SeverityUpgrade => Properties.severityUpgrade == null ? 0
            : CasterPawn?.TryGetComp<CompAbilityUserCustom>().Data.GetUpgradeLevel(Properties.severityUpgrade?.UpgradeId) ?? 0;
