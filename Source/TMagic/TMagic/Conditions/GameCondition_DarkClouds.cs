    ...
    public class GameCondition_DarkClouds : GameCondition
    {
        ...
        public override void GameConditionTick()
        {
            if(Find.TickManager.TicksGame % 37 == 0)
            {
                ...
                if (p.def != TorannMagicDefOf.TM_GiantSkeletonR && p.def != TorannMagicDefOf.TM_SkeletonLichR && p.def != TorannMagicDefOf.TM_SkeletonR && p.health != null && !p.Downed && p.health.hediffSet != null && !TM_Calc.IsUndead(p))
                {
