    ...
    public class Projectile_HealingCircle : Projectile_AbilityBase
    {
        ...
        public void Search(Map map)
        {
            ...
            {                
                ...
                {
                    TM_Action.DamageUndead(pawn, (6.0f + (float)pwrVal * 3f) * this.arcaneDmg, this.launcher);
                }
            }
        }
                            ...
                            foreach (Hediff_Injury current in arg_BB_0.Where(arg_BB_1))
                            {
                                ...
                                if (flag4)
                                {
                                    ...
                                    if (flag5)
                                    {
                                        ...
                                        if (Rand.Chance(.8f))
                                        {
                                            current.Heal((6.0f + (float)pwrVal * 3f) * this.arcaneDmg); // power affects how much to heal
