...
namespace TorannMagic
{
    ...
    public class Projectile_Whirlwind : Projectile_AbilityBase
    {
        private static readonly Color cleaveColor = new Color(160f, 160f, 160f);
        private static readonly Material cleavingMat = MaterialPool.MatFrom("Spells/cleave", ShaderDatabase.Transparent, Projectile_Whirlwind.cleaveColor);
        ...
        private void DrawCleaving(Pawn shieldedPawn, int magnitude)
        {
            ...
            if (flag)
            {
                ...
                Graphics.DrawMesh(MeshPool.plane10, matrix, Projectile_Whirlwind.cleavingMat, 0);
